...
data = pd.read_csv(r"C:\Users\LAMIA\Desktop\Glovo_orkaisse\ca_glovo.csv", delimiter=';')
...
def copy_from_file(conn, df, table):
    ...
    tmp_df = "C:/Users/LAMIA/Desktop/traitement_ca_glovo/ca_glovo.csv"
...
def flash_table():
    cursor = conn.cursor()
    cursor.execute("TRUNCATE table ca_glovo;")
    conn.commit()
    print("flash last data table has ben successfuly")
    cursor.close()

############## Suppression file stock_0
fileTest3 = r"C:\Users\LAMIA\Desktop\Glovo_orkaisse\ca_glovo.csv"
...
#flash_table()
copy_from_file(conn, df, 'ca_glovo')
