...
order_test = [1802, 1218, 605, 599, 592, 584, 581, 580, 578, 559, 1191, 1189, 1184, 1183, 1182, 1154, 1146, 1142, 1136,
              ...
              1043, 1042, 1041, 1040, 1039, 1035, 1033, 1032, 1031, 1016, 996, 995, 992, 991, 989, 987, 986, 980, 969,
              968, 967, 960, 961, 962, 968, 967, 969, 975, 977, 979, 1235, 1138, 1137, 1134, 1122, 1070, 1045, 1061,
...
# for i in dfs:
#     y = i.to_csv("C:/Users/LAMIA/Desktop/rapport_financier/Financial_rapport.csv", mode="a", sep=";", index= True, header=True)
#
#
# df = pd.read_csv("C:/Users/LAMIA/Desktop/rapport_financier/Financial_rapport.csv")
# df.to_excel("Financial_rapportt.xls")
...
with pd.ExcelWriter("C:/Users/LAMIA/Desktop/rapport_financier/Financial_rapport.xls") as writer:
