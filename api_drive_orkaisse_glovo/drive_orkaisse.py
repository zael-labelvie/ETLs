...
file_list = drive.ListFile({'q': "'1XwRQ58Ebx5byGRmtelmy47DzJo19zDig' in parents and trashed=false"}).GetList()
li =[]
print(li)
...
try:
    ...
    for file_id, file_name in zip(file_ids, file_names):
        ...
        with open(os.path.join('C:/Users/LAMIA/Desktop/Glovo_orkaisse', file_name), 'wb') as f:
            f.write(fh.read())
            f.close()
    li.clear()
except:
...
source_folder_id = '1XwRQ58Ebx5byGRmtelmy47DzJo19zDig'
target_folder_id = '1yytdoqJjvO7mZyVnhnINFR0fYpRNZKvL'
