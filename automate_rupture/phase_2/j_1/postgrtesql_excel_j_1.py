...
print(df_vision_product)
table_j_1 = df_vision_product.loc[(df_vision_product['order_date'] == yesterday)]


table_titre  = pd.DataFrame(columns=["Vision product J-1 : {}".format(yesterday)])
...
x1 = x0 + 2
#Export to excel
with pd.ExcelWriter("C:/Users/LAMIA/Desktop/rapport_rupture/Etat Rupture Journalier {}.xls".format(yesterday)) as writer:
...
print(table_j_1[["Magasin","Date début","Produit",'Code interne',"Status produit","Quantité","Prix unitaire","Département", "Rayon", "Famille", "Sous Famille"]])
...
#print(TCD[['Prix unitaire', 'Quantité']])
