...
file_list = drive.ListFile({'q': "'1wK3lugcNz2nnuvQYjPvxBwpIEiFrkntz' in parents and trashed=false"}).GetList()
li =[]
...
try:
    file_ids = [li[0].get('id'), li[1].get('id')]
    file_names = ['crf.xlsx', 'rrd.xlsx']
    for file_id, file_name in zip(file_ids, file_names):
        ...
        with open(os.path.join('C:/Users/LAMIA/Desktop/Glovo_externe', file_name), 'wb') as f:
            f.write(fh.read())
            f.close()
    li.clear()
except:
...
source_folder_id = '1wK3lugcNz2nnuvQYjPvxBwpIEiFrkntz'
target_folder_id = '1VXM3RFRAy1qnsv5U56t26EjjsyP2GKW9'
